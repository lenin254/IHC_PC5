 ...
 * Slug: blockskit-education/template-blog-listing
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"blockskit-education"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->